...
public class TutorialManager : MonoBehaviour
{
    ...
    private static string DESCRIPTION_14 = "Now you have learned all actions. Go back to the menu to play a standard game. Good luck.";
    ...
    private void Start()
    {
        if (GameManager.Instance.IsTutorial)
        {
            ...
            Hint SEE_APPLY_PHASE = Hint.OfTask(DESCRIPTION_5, () => tutorialHelper.IsVoronoiPhase());
            Hint SEE_VORONOI_PHASE= Hint.OfTask(DESCRIPTION_6, () => tutorialHelper.IsDeathPhase());
